                ...
                <div class="col-md-12">
                    <div class="w-auto p-3">
                        <div class="panel-heading-admin">
                            <h5>Dados de <strong>{{ $ambiente->nome }}</strong></h5>
                        </div>
                        <div class="panel-body">
                            <div class="row btn-new-reset">
                                <p><a href="{{route('pesq.ambientes.edit', ['ambiente' => $ambiente->id])}}" class="btn btn-primary btn-assinar">Editar</a></p>
                                <p><a href="{{route('pesq.ambientes.index')}}" class="btn btn-success btn-assinar">Voltar</a></p>
                            ...
                            <div class="row">
                                <div id="register-show">
                                    <div class="row bloco-div-show desk">
                                        ...
                                        <div class="nome">
                                            <h6 class="block font-medium text-sm text-gray-700 label-show">Tipo de uso</h6>
                                            <div class="texto-show">
                                                {{ $ambiente->tipo }}
                                            </div>
                                        </div>
                                        <div class="nome">
                                            <h6 class="block font-medium text-sm text-gray-700 label-show">Predio</h6>
                                            <div class="texto-show">
                                                {{ $ambiente->andar->ala->predio->nome }}
                                            </div>
                                        </div>
                                        <div class="nome">
                                            <h6 class="block font-medium text-sm text-gray-700 label-show">Num</h6>
                                            <div class="texto-show">
                                                {{ $ambiente->num }}
                                            </div>
                                        </div>
                                    ...
                                    <div class="row bloco-div-show desk-esq">
                                        <div class="nome dt-nasc">
                                            <h6 class="block font-medium text-sm text-gray-700 label-show">Tag</h6>
                                            <div class="texto-show">
                                                {{ $ambiente->tag}}
                                            </div>
                                        </div>
