                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="w-auto p-3">
                            <div class="col-12">
                                <h5 style="text-align: center">Eleição Senador <strong>{{$detalhe->nm_municipio}} - Comparecimento: {{number_format((float)($detalhe->aptos - $detalhe->abstencoes),0, '', '.')}}</strong></h5>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="form-search">
                                    <form action="{{route('show_munic_sen', ['munic' => $munic])}}" method="get">
                                ...
                                <div class="row btn-new-reset">
                                    <div class="btn-hero">
                                        ...
                                        <p><a href="{{route('show_munic_sen', ['munic' => $munic])}}" class="btn btn-primary btn-assinar">Limpar</a></p>
                                    </div>
                                </div>
