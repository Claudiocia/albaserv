                ...
                <div class="col-md-12">
                    <div class="w-auto p-3">
                        <div class="panel-heading-admin">
                            <h5><strong>Sistema:</strong> {{ $role->nome }}</h5>
                        </div>
                        <div class="panel-body">
                            <div class="row btn-new-reset">
                                <p><a href="{{route('admin.roles.edit', ['role' => $role->id])}}" class="btn btn-primary btn-assinar">Editar</a></p>
                                <p><a href="{{route('admin.roles.index')}}" class="btn btn-success btn-assinar">Voltar</a></p>
