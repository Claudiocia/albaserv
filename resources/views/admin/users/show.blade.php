                                ...
                                <div id="register-show">
                                    ...
                                    <div class="row bloco-div-show desk-esq">
                                        <div class="nome dt-nasc">
                                            <h6 class="block font-medium text-sm text-gray-700 label-show">Setor</h6>
                                            <div class="texto-show">
                                                {{ $user->lotacao}}
                                            </div>
                                        </div>
                                        <div class="nome dt-nasc">
                                            <h6 class="block font-medium text-sm text-gray-700 label-show">Celular</h6>
                                            <div class="texto-show">
                                                {{$user->celular}}
                                            </div>
                                        </div>
                                        <div class="nome dt-nasc">
                                            <h6 class="block font-medium text-sm text-gray-700 label-show">Ramal</h6>
                                            <div class="texto-show">
                                                {{$user->ramal}}
                                            </div>
                                        </div>
