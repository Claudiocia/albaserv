                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="w-auto p-3">
                            <div class="col-12">
                                <h5 style="text-align: center">Eleição Deputado Federal <strong>{{$detalhe->nm_municipio}} - Comparecimento: {{number_format((float)($detalhe->aptos - $detalhe->abstencoes),0, '', '.')}}</strong></h5>
                            </div>
                                   ...
                                   <table class="table table-striped">
                                       ...
                                       @foreach($depests as $depest)
                                           <tr>
                                               ...
                                               <td style="text-align: center; color: #0a58f6;"><a href="{{route('show_depfed', ['cand' => $depest->sq_candidato])}}"><i class="fas fa-eye"></i></a></td>
                                           </tr>
                                       @endforeach
                                       @foreach($suplentes as $suplente)
                                           <tr>
                                               ...
                                               <td style="text-align: center; color: #0a58f6;"><a href="{{route('show_depfed', ['cand' => $suplente->sq_candidato])}}"><i class="fas fa-eye"></i></a></td>
                                           </tr>
                                       @endforeach
                                       @foreach($naoeleitos as $naoeleito)
                                           <tr>
                                               ...
                                               <td style="text-align: center; color: #0a58f6;"><a href="{{route('show_depfed', ['cand' => $naoeleito->sq_candidato])}}"><i class="fas fa-eye"></i></a></td>
                                           </tr>
                                       @endforeach
                                   </table>
                                </div>
