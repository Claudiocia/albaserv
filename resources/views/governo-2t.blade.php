                    ...
                    <div class="col-md-12">
                        <div class="w-auto p-3">
                            <div class="panel-heading-admin">
                                <h5>Resultado Eleição Governador 2º Turno</h5>
                                <div class="form-search">
                                    <form action="{{route('governo-2t')}}" method="get">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row btn-new-reset">
                                    <div class="btn-hero">
                                        ...
                                        <p><a href="{{route('governo-2t')}}" class="btn btn-primary btn-assinar">Limpar</a></p>
                                    </div>
                                </div>
